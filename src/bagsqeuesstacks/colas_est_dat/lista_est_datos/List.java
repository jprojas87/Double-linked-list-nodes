package bagsqeuesstacks.colas_est_dat.lista_est_datos;

// Una lista es una colección ordenada de elementos desde la cual se puede acceder a cada dato por su índice.

// Métodos:
/*
add(T elemento): Añade un elemento al final de la lista.
get(int índice): Devuelve el elemento en la posición dada.
remove(int índice): Elimina el elemento en la posición dada.
size(): Devuelve el número de elementos en la lista.
isEmpty(): Devuelve verdadero si la lista está vacía.
clear(): Vacía la lista, eliminando todos los elementos.
*/
